...
function App() {
      ...
      svg: (
        <svg
          ...
          <path
            ...
            stroke={location.pathname === '/dashboard' ? '#141726' : 'rgba(255, 255, 255, 0.6)'}
            strokeWidth='1.5'
            strokeLinecap='round'
      ...
      svg: (
        <svg
          ...
          <path
            ...
            fill={`${location.pathname === '/transactions' ? '#141726' : 'rgba(255, 255, 255, 0.6)'}`}
          />
          <path
    ...
    },
    {
      ...
      svg: (
        <svg
          ...
          <path
            d='M2 8.50488H22'
            stroke={`${location.pathname === '/top-up' ? '#141726' : 'rgba(255, 255, 255, 0.6)'}`}
            strokeWidth='1.5'
            strokeMiterlimit='10'
            strokeLinecap='round'
            strokeLinejoin='round'
  ...
  useEffect(() => {
    ...
    if (triedReconnect) {
      if (account) {
        if (library && metaAcc) {
          if (metaAcc?.address === account?.toLowerCase() && metaAcc.email && metaAcc.name) {
