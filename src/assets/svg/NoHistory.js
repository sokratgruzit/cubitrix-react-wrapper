const NoHistoryIcon = () => {
    return (
      ...
      >
        ...
        />
        <path
          d="M64.1268 53.2074C65.0543 56.0074 67.1718 56.2874 68.7993 53.8374C70.2868 51.5974 69.3068 49.7599 66.6118 49.7599C64.6168 49.7424 63.4968 51.2999 64.1268 53.2074V53.2074Z"
          stroke="#796AD5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
