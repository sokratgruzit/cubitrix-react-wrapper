...
const LandingRegistration = ({ step, setStep, setInitialRegister }) => {
  ...
  const { connect, disconnect, error, setError, connectionLoading, library } = useConnect()
  ...
  const [receivePaymentAddress, setReceivePaymentAddress] = useState('0x43f59F41518903A274c7897dfFB24DB86a0dd23a')
  ...
  const { depositAmount, timeperiod, isAllowance, timeperiodDate, loading } = useSelector(state => state.stake)
